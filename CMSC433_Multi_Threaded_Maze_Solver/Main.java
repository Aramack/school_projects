...
public class Main
{
    ...
    public void solve()
    {
        ...
        MazeSolver[] solvers =
        {
        		...
        		//new StudentMTMazeSolverFork(maze),
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        String mazeLocationNotInProjectFolder = "C:\\Users\\Mark\\Google Drive\\School\\Computer\\CMSC433\\maze-dist\\"; //replace this with your maze directory
        String whichMazeToUse = "4000x4000u.mz"; //which maze file to load
